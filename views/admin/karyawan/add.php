<?php get_template_home('admin/header') ?>
    ...
    <div class="container-fluid mt--6">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <?php echo form_open_multipart(base_url('admin/karyawan/store')); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="nik_karyawan" class="form-control" placeholder="NIK" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace();" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="no_telp_karyawan" class="form-control" placeholder="No. HP" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="atasan_langsung" class="form-control" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="email_karyawan" class="form-control" placeholder="Email" value="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="salary" class="form-control" placeholder="Rp." oninput="this.value = this.value.replace(/[^0-9]/g, '').replace();">
                    </div>
                  </div>
                </div>
              <?php endif ?>
